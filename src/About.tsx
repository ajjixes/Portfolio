      ...
      <div className="flex flex-col lg:flex-row mx-auto gap-4 lg:gap-2 items-center justify-center pt-4">
        ...
        <div className="order-2 lg:order-3 flex flex-row lg:flex-col gap-2 ">
          <div className="flex gap-2">
            <div className="bg-secondary h-[50px] lg:h-[96px] w-[50px] lg:w-[96px] rounded-2xl flex items-center justify-center ">
              <svg
            ...
            <div className="bg-white h-[50px] lg:h-[96px] w-[50px] lg:w-[96px] rounded-2xl flex items-center justify-center ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8"
                viewBox="0 0 24 24"
          ...
          <div className="flex gap-2">
            <div className="bg-white h-[50px] lg:h-[96px] w-[50px] lg:w-[96px] rounded-2xl flex items-center justify-center ">
              ...
              >
                <path
                  d="M2.396 19H6.396V10.99H10L10.396 7.01H6.396V5C6.396 4.73478 6.50136 4.48043 6.68889 4.29289C6.87643 4.10536 7.13078 4 7.396 4H10.396V0H7.396C6.06992 0 4.79815 0.526784 3.86047 1.46447C2.92278 2.40215 2.396 3.67392 2.396 5V7.01H0.396L0 10.99H2.396V19Z"
                  fill="black"
                />
              </svg>
            </div>
