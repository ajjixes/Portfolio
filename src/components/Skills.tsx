...
function Skills() {
  ...
  return (
    <div>
      ...
      <div className="relative mainSlides bg-soft h-auto w-11/12 lg:w-[920px] rounded-2xl py-2">
        {/* <div className="absolute top-[32px] left-[32px] font-sans font-semibold text-2xl uppercase text-white">
        Skills
      </div> */}
        <div className="absolute left-0 top-0 bg-gradient-to-r from-soft min-w-[150px] min-h-[120px] z-10 rounded-t-2xl"></div>
        <div className="absolute right-0 top-0 bg-gradient-to-l from-soft min-w-[150px] min-h-[120px] z-10 rounded-t-2xl"></div>
